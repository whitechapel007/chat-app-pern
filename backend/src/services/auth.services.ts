...
export const signup = async (data: SignupData) => {
  // Validate input data
  const { value: validatedData, error } = validateInput<SignupData>(
    signupSchema,
    data
  );
  if (error) {
...
export const signin = async (data: SigninData) => {
  // Validate input data
  const { value: validatedData, error } = validateInput<SigninData>(
    signinSchema,
    data
  );
  if (error) {
...
export const changePassword = async (
  ...
  // Validate input data
  const { value: validatedData, error } = validateInput<ChangePasswordData>(
    changePasswordSchema,
    data
  );
  if (error) {
